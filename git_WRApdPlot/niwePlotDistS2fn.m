function niwePlotDistS2fn(summer,rainy,autumn,winter)
%% This function plots the frequency histogram and fitted distributions
% for NIWE data; this plots four seasons in one plot.
...
plot(xS2,pdf_TNWvalS,'-g','LineWidth',2)
...
title('Summer (TNW)','fontsize',12,'fontweight','b','color','k')
...
ylabel('Probability','fontsize',12,'fontweight','b','color','k')
xlabel('Wind Speed(m/s)','fontsize',12,'fontweight','b','color','k')
title('Rainy (Nakagami)','fontsize',12,'fontweight','b','color','k')
...
plot(xA,pdf_GWvalA,'-g','LineWidth',2)
% legend('Histogram','Loglogistics','WW','GW','Orientation','Vertical')
ylabel('Probability','fontsize',12,'fontweight','b','color','k')
xlabel('Wind Speed(m/s)','fontsize',12,'fontweight','b','color','k')
title('Autumn (GW)','fontsize',12,'fontweight','b','color','k')
...
plot(xW,pdf_WWvalW,'-g','LineWidth',2)
...
ylabel('Probability','fontsize',12,'fontweight','b','color','k')
xlabel('Wind Speed(m/s)','fontsize',12,'fontweight','b','color','k')
title('Winter (WW)','fontsize',12,'fontweight','b','color','k')
