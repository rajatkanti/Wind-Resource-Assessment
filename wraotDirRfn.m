function windSpeed = wraotDirRfn( periodC,mon )
...
switch(periodC)
    case 1        
        ...
        yearData=xlsread('F:\MATLAB\IOFiles\NIWEio\NIWEdir78.xlsx', 'Year', 'D6:H8765');
        windSpeed=yearData(1:8760,1);
    case 2
        %% Monthly data
        % disp('Now reading monthly hourly average data...')
        monData=xlsread('F:\MATLAB\IOFiles\NIWEio\NIWEdir78.xlsx', 'Hourly', 'D6:O749'); 
    ...
    case 3 
        ...
        switch(mon) % mon variable is also used for seasons. :)
            case 13
                windSpeed=winter;
            case 14
                windSpeed=summer;
